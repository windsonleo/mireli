    ...
    <div class="main-menu menu-fixed menu-dark menu-bg-default rounded menu-accordion menu-shadow">
      <div class="main-menu-content"><a class="navigation-brand d-none d-md-block d-lg-block d-xl-block" href="index.php"><img class="brand-logo" alt="CryptoDash admin logo" src="../images/logo/logo.png"/></a>
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="active"><a href="psicologoss.php"><i class="icon-user"></i><span class="menu-title" data-i18n="">Psicologos</span></a>
          </li>
    ...
    <div class="app-content content">
      <div class="content-wrapper">
        ...
        <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Psicologos</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.php">Dashboard</a>
                  </li>
                  <li class="breadcrumb-item active">Psicologos
                  </li>
                </ol>
              </div>
            </div>
          ...
          <div class="content-header-right col-md-4 col-12 d-none d-md-inline-block">
            <div class="btn-group float-md-right"><a class="btn-gradient-secondary btn-sm white" href="addpsicologos.html">Adicionar Psicologo</a></div>
          </div>
                        ...
                        <thead>
                            <tr>
                               <th class="border-top-0">Id</th>
                                ...
                                <th class="border-top-0">Data Nascimento</th>
...
$sql = mysqli_query($conn,"select * from psicologo") or die("Erro");
...
<?php endif; ?></a> </td>
                                <td class="text-truncate"><a href="#"><?php echo $nome; ?></a><?php $nome; ?></td>
                                <td class="text-truncate">
                                    <a href="#" ><?php echo $datan; ?></a>
                                </td>
                                <td class="text-truncate p-1"><?php echo $foto; ?></td>
                                <td>
                                    <?php echo $email ?>
                                </td>
                                <td class="text-truncate"><?php echo $telefone; ?></td>
