      ...
      <div class="content-wrapper">
        ...
        <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
          ...
          <div class="content-header-right col-md-4 col-12 d-none d-md-inline-block">
            <div class="btn-group float-md-right"><a class="btn-gradient-secondary btn-sm white" href="addpaciente.php">Adicionar Paciente</a></div>
          </div>
...
$sql = mysqli_query($conn,"select * from paciente") or die("Erro");
  ...
  $psicologoid = $dados['psicologo_id'];
...
<?php endif; ?></a> </td>
                                ...
                                <td class="text-truncate"><?php echo $telefone; ?></td>
                                 <td class="text-truncate"><?php echo $psicologoid; ?></td>
