      ...
      <div class="main-menu-content"><a class="navigation-brand d-none d-md-block d-lg-block d-xl-block" href="index.php"><img class="brand-logo" alt="CryptoDash admin logo" src="../images/logo/logo.png"/></a>
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="psicologoss.php"><i class="icon-user"></i><span class="menu-title" data-i18n="">Psicologos</span></a>
                              ...
                              <li class="active"><a href="servicos.php"><i class="la la-dashcube"></i><span class="menu-title" data-i18n="">Serviços</span></a>
          </li>
    ...
    <div class="app-content content">
      <div class="content-wrapper">
        ...
        <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Adicionar Serviços</h3>
            <div class="row breadcrumbs-top d-inline-block">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="servicos.php">Serviços</a>
                  </li>
                  <li class="breadcrumb-item active">Adicionar Serviços
                  </li>
                </ol>
              </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-12">
                                ...
                                <form method="POST" class="form-horizontal form-user-profile row mt-2" action="../dao/servicoDao.php">
                                    ...
                                    <div class="col-6">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" id="modalidade" value="" required="" autofocus="" name="modalidade">
