    ...
    <div class="app-content content">
      <div class="content-wrapper">
        ...
        <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Serviços</h3>
          ...
          <div class="content-header-right col-md-4 col-12 d-none d-md-inline-block">
            <div class="btn-group float-md-right"><a class="btn-gradient-secondary btn-sm white" href="addservico.php">Adicionar Serviços</a></div>
          </div>
...
$sql = mysqli_query($conn,"select * from servico") or die("Erro");
...
<?php endif; ?></a> </td>
                                ...
                                <td class="text-truncate"><?php echo $modalidade; ?></td>
